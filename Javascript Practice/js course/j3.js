...
// ---------- EXAMPLE 1 ----------
const numbers40 = [1, 10, 2, 9, 3, 8, 4, 7, 5, 6];

numbers40.sort((a, b) => a - b); //FORWARD
numbers40.sort((a, b) => b - a); //REVERSE

console.log(numbers40);

// ---------- EXAMPLE 2 ----------
const people = [{name: "Brian", age: 21, gpa: 4.0},
                            {name: "Anira", age: 22, gpa: 3.3},
                            {name: "Marcus", age: 21, gpa: 3.6},
                            {name: "Mary", age: 21, gpa: 3.9}]
